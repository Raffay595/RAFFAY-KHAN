...
// Custom Timer class fallback to guarantee compatibility and prevent frame jumps when tab is inactive
class CustomTimer {
  constructor() {
  ...
  update() {
    ...
    // Cap delta to 0.1s to avoid physics explosions when switching tabs
    this.delta = Math.min((now - this.previousTime) / 1000, 0.1);
...
// Map reactant bindings to Three objects
const a = THREE.Vector3;
const c = THREE.MeshPhysicalMaterial;
const d = THREE.InstancedMesh;
const e = CustomTimer;
const f = THREE.AmbientLight;
const g = THREE.SphereGeometry;
const h = THREE.ShaderChunk;
const i = THREE.Scene;
const l = THREE.Color;
const m = THREE.Object3D;
const n = THREE.SRGBColorSpace;
const o = THREE.MathUtils;
const p = THREE.PMREMGenerator;
const r = THREE.Vector2;
const s = THREE.WebGLRenderer;
const t = THREE.PerspectiveCamera;
const u = THREE.PointLight;
const v = THREE.ACESFilmicToneMapping;
const w = THREE.Plane;
const y = THREE.Raycaster;
const z = RoomEnvironment;
...
// Attach globally for regular scripts to access
window.createBallpit = createBallpit;
